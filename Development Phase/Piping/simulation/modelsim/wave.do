...
add wave -noupdate -radix decimal /testbench/uut/dcd/cmp/In1
add wave -noupdate -radix decimal /testbench/uut/dcd/cmp/In2
add wave -noupdate -radix decimal /testbench/uut/dcd/cmp/branchValid
add wave -noupdate -radix decimal /testbench/uut/fetch/PCMux/s
add wave -noupdate -radix decimal /testbench/uut/fetch/PCMux/in1
add wave -noupdate -radix decimal /testbench/uut/fetch/PCMux/in2
add wave -noupdate -radix decimal /testbench/uut/fetch/PCMux/out
add wave -noupdate -radix decimal /testbench/uut/fetch/JRMux/s
add wave -noupdate -radix decimal /testbench/uut/fetch/JRMux/in1
add wave -noupdate -radix decimal /testbench/uut/fetch/JRMux/in2
add wave -noupdate -radix decimal /testbench/uut/fetch/JRMux/out
add wave -noupdate -radix decimal /testbench/uut/fetch/jumpMux/s
add wave -noupdate -radix decimal /testbench/uut/fetch/jumpMux/in1
add wave -noupdate -radix decimal /testbench/uut/fetch/jumpMux/in2
add wave -noupdate -radix decimal /testbench/uut/fetch/jumpMux/out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {47094 ps} 0}
...
update
WaveRestoreZoom {0 ps} {120870 ps}
